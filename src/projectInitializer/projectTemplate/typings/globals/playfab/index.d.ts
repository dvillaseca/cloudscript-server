...
interface IPlayFabContext {
  playStreamEvent: any; // PlayStreamModels.IBasePlayStreamEvent;
...
export namespace PlayFabServerModels {
  ...
  interface GetPlayerProfileRequest {
     ...
     * the Game Manager "Client Profile Options" tab in the "Settings" section.
     */
    ProfileConstraints?: Partial<PlayerProfileViewConstraints>;
  }
  ...
  interface UpdatePlayerStatisticsRequest {
    PlayFabId: string;
    UserStatistics: StatisticUpdate[];
  }
...
interface IPlayFabServerAPI {
  ...
  ): PlayFabServerModels.ModifyCharacterVirtualCurrencyResult;
  ...
  ): PlayFabServerModels.AddPlayerTagResult;
  ...
  ): PlayFabServerModels.AddSharedGroupMembersResult;
  ...
  ): PlayFabServerModels.AuthenticateSessionTicketResult;
  ...
  ): PlayFabServerModels.AwardSteamAchievementResult;
  ...
  ): PlayFabServerModels.BanUsersResult;
  ...
  ): PlayFabServerModels.CreateSharedGroupResult;
  ...
  ): PlayFabServerModels.DeleteCharacterFromUserResult;
  ...
  ): PlayFabServerModels.DeletePlayerResult;
  ...
  ): PlayFabServerModels.DeletePushNotificationTemplateResult;
  ...
  ): PlayFabServerModels.DeregisterGameResponse;
  ...
  ): PlayFabServerModels.EvaluateRandomResultTableResult;
  ...
  ): PlayFabServerModels.ExecuteCloudScriptResult;
  ...
  ): PlayFabServerModels.GetAllSegmentsResult;
  ...
  ): PlayFabServerModels.ListUsersCharactersResult;
  ...
  ): PlayFabServerModels.GetCharacterDataResult;
  ...
  ): PlayFabServerModels.GetCharacterInventoryResult;
  ...
  ): PlayFabServerModels.GetCharacterLeaderboardResult;
  ...
  ): PlayFabServerModels.GetCharacterStatisticsResult;
  ...
  ): PlayFabServerModels.GetContentDownloadUrlResult;
  ...
  ): PlayFabServerModels.GetFriendsListResult;
  ...
  ): PlayFabServerModels.GetLeaderboardAroundCharacterResult;
  ...
  ): PlayFabServerModels.GetLeaderboardAroundUserResult;
  ...
  ): PlayFabServerModels.GetLeaderboardForUsersCharactersResult;
  ...
  ): PlayFabServerModels.GetPlayerProfileResult;
  ...
  ): PlayFabServerModels.GetPlayerSegmentsResult;
  ...
  ): PlayFabServerModels.GetPlayersInSegmentResult;
  ...
  ): PlayFabServerModels.GetPlayerStatisticsResult;

  GetUserStatistics(
    request: PlayFabServerModels.GetUserStatisticsRequest
  ): PlayFabServerModels.GetUserStatisticsResult;
  ...
  ): PlayFabServerModels.GetPlayerStatisticVersionsResult;
  ...
  ): PlayFabServerModels.GetPlayerTagsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromFacebookIDsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromFacebookInstantGamesIdsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromGenericIDsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromNintendoSwitchDeviceIdsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromPSNAccountIDsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromSteamIDsResult;
  ...
  ): PlayFabServerModels.GetPlayFabIDsFromXboxLiveIDsResult;
  ...
  ): PlayFabServerModels.GetPublisherDataResult;
  ...
  ): PlayFabServerModels.GetRandomResultTablesResult;
  ...
  ): PlayFabServerModels.GetServerCustomIDsFromPlayFabIDsResult;
  ...
  ): PlayFabServerModels.GetSharedGroupDataResult;
  ...
  ): PlayFabServerModels.GetStoreItemsResult;
  ...
  ): PlayFabServerModels.GetTimeResult;
  ...
  ): PlayFabServerModels.GetTitleDataResult;
  ...
  ): PlayFabServerModels.GetTitleNewsResult;
  ...
  ): PlayFabServerModels.GetUserAccountInfoResult;
  ...
  ): PlayFabServerModels.GetUserBansResult;
  ...
  ): PlayFabServerModels.GrantCharacterToUserResult;
  ...
  ): PlayFabServerModels.GrantItemsToCharacterResult;
  ...
  ): PlayFabServerModels.GrantItemsToUserResult;
  ...
  ): PlayFabServerModels.LinkPSNAccountResult;
  ...
  ): PlayFabServerModels.LinkServerCustomIdResult;
  ...
  ): PlayFabServerModels.LinkXboxAccountResult;
  ...
  ): PlayFabServerModels.ServerLoginResult;
  ...
  ): PlayFabServerModels.ModifyItemUsesResult;
  ...
  ): PlayFabServerModels.MoveItemToCharacterFromCharacterResult;
  ...
  ): PlayFabServerModels.MoveItemToCharacterFromUserResult;
  ...
  ): PlayFabServerModels.MoveItemToUserFromCharacterResult;
  ...
  ): PlayFabServerModels.NotifyMatchmakerPlayerLeftResult;
  ...
  ): PlayFabServerModels.RedeemCouponResult;
  ...
  ): PlayFabServerModels.RedeemMatchmakerTicketResult;
  ...
  ): PlayFabServerModels.RefreshGameServerInstanceHeartbeatResult;
  ...
  ): PlayFabServerModels.RegisterGameResponse;
  ...
  ): PlayFabServerModels.RemovePlayerTagResult;
  ...
  ): PlayFabServerModels.RemoveSharedGroupMembersResult;
  ...
  ): PlayFabServerModels.ReportPlayerServerResult;
  ...
  ): PlayFabServerModels.RevokeAllBansForUserResult;
  ...
  ): PlayFabServerModels.RevokeBansResult;
  ...
  ): PlayFabServerModels.RevokeInventoryResult;
  ...
  ): PlayFabServerModels.RevokeInventoryItemsResult;
  ...
  ): PlayFabServerModels.SavePushNotificationTemplateResult;
  ...
  ): PlayFabServerModels.SendCustomAccountRecoveryEmailResult;
  ...
  ): PlayFabServerModels.SendEmailFromTemplateResult;
  ...
  ): PlayFabServerModels.SendPushNotificationResult;
  ...
  ): PlayFabServerModels.SetGameServerInstanceDataResult;
  ...
  ): PlayFabServerModels.SetGameServerInstanceStateResult;
  ...
  ): PlayFabServerModels.SetGameServerInstanceTagsResult;
  ...
  ): PlayFabServerModels.SetPlayerSecretResult;
  ...
  ): PlayFabServerModels.SetPublisherDataResult;
  ...
  ): PlayFabServerModels.SetTitleDataResult;
  ...
  ): PlayFabServerModels.UnlinkPSNAccountResult;
  ...
  ): PlayFabServerModels.UnlinkServerCustomIdResult;
  ...
  ): PlayFabServerModels.UnlinkXboxAccountResult;
  ...
  ): PlayFabServerModels.UpdateBansResult;
  ...
  ): PlayFabServerModels.UpdateCharacterDataResult;
  ...
  ): PlayFabServerModels.UpdateCharacterStatisticsResult;
  ...
  UpdateUserStatistics(
    request: PlayFabServerModels.UpdateUserStatisticsRequest
  ): PlayFabServerModels.UpdatePlayerStatisticsResult;
  ...
  ): PlayFabServerModels.UpdateSharedGroupDataResult;
  ...
  ): PlayFabServerModels.WriteEventResponse;
...
interface IPlayFabEntityAPI {
  ...
  ): PlayFabAuthenticationModels.ValidateEntityTokenResponse;
  ...
  ): PlayFabDataModels.AbortFileUploadsResponse;
  ...
  ): PlayFabDataModels.DeleteFilesResponse;
  ...
  ): PlayFabDataModels.FinalizeFileUploadsResponse;
  ...
  ): PlayFabDataModels.GetFilesResponse;
  ...
  ): PlayFabDataModels.GetObjectsResponse;
  ...
  ): PlayFabDataModels.InitiateFileUploadsResponse;
  ...
  ): PlayFabDataModels.SetObjectsResponse;
  ...
  ): PlayFabEventsModels.WriteEventsResponse;
  ...
  ): PlayFabGroupsModels.EmptyResponse;
  ...
  ): PlayFabGroupsModels.ApplyToGroupResponse;
  ...
  ): PlayFabGroupsModels.CreateGroupResponse;
  ...
  ): PlayFabGroupsModels.CreateGroupRoleResponse;
  ...
  ): PlayFabGroupsModels.GetGroupResponse;
  ...
  ): PlayFabGroupsModels.InviteToGroupResponse;
  ...
  ): PlayFabGroupsModels.IsMemberResponse;
  ...
  ): PlayFabGroupsModels.ListGroupApplicationsResponse;
  ...
  ): PlayFabGroupsModels.ListGroupBlocksResponse;
  ...
  ): PlayFabGroupsModels.ListGroupMembersResponse;
  ...
  ): PlayFabGroupsModels.ListMembershipResponse;
  ...
  ): PlayFabGroupsModels.ListMembershipOpportunitiesResponse;
  ...
  ): PlayFabGroupsModels.UpdateGroupResponse;
  ...
  ): PlayFabGroupsModels.UpdateGroupRoleResponse;
  ...
  ): PlayFabProfilesModels.GetGlobalPolicyResponse;
  ...
  ): PlayFabProfilesModels.GetEntityProfileResponse;
  ...
  ): PlayFabProfilesModels.GetEntityProfilesResponse;
  ...
  ): PlayFabProfilesModels.GetTitlePlayersFromMasterPlayerAccountIdsResponse;
  ...
  ): PlayFabProfilesModels.SetGlobalPolicyResponse;
  ...
  ): PlayFabProfilesModels.SetProfileLanguageResponse;
  ...
  ): PlayFabProfilesModels.SetEntityProfilePolicyResponse;
}
